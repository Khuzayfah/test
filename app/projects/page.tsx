...
export default function Projects() {
  ...
  return (
    <PageLayout
      ...
      description="Explore our portfolio of successful digital marketing campaigns and projects that have delivered measurable results for our clients."
    >
      {/* Filter categories */}
        ...
        {filteredProjects.map((project) => (
          ...
          >
            <div className="h-48 bg-gray-200 relative overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500/20 to-blue-700/30 flex items-center justify-center text-white text-4xl">
            ...
            <div className="p-6">
              <div className="trust-badge mb-4 text-xs">{project.category}</div>
              ...
              <Link 
                ...
                className="trust-link inline-flex items-center"
              >
                View case study
